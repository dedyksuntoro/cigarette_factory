...
if (!isset($_SESSION['user_id']) || !hasPermission($role, ['create_all', 'create_roles'])) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt->execute([$_SESSION['user_id'], "Menambahkan peran pengguna baru: $name"]);

        header('Location: '.$_ENV['BASE_URL'].'/page/roles/list.php');
        exit();
    } catch (PDOException $e) {
        $error = "Gagal menambah peran pengguna: " . $e->getMessage();
    }
}
